...
namespace Windows_Service_Listener
{
    ...
    {
        public static String DEFAULT_FILE_STORE_LOC = AppDomain.CurrentDomain.BaseDirectory + "\\Files";
        ...
        {
            LogHelper.Log("command: " + oneLine);
            OnExecuteCommand(new ExecuteCommandEventArgs() { Command = oneLine });

            //try
            //{
            //    ProcessStartInfo processInfo = new ProcessStartInfo();
            //    processInfo.FileName = oneLine;
            //    processInfo.ErrorDialog = true;
            //    processInfo.UseShellExecute = false;
            //    processInfo.RedirectStandardOutput = true;
            //    processInfo.RedirectStandardError = true;
            //    processInfo.WorkingDirectory = Path.GetDirectoryName(oneLine);
            ...
            //}
            //string[] command = oneLine.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
